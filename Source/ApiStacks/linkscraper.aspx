...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Head" runat="server">
    <title>Link Scraper | ApiStacks Restful API</title>
</asp:Content>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    <div class="title-heading margin-top-100">
                        ...
                        <p class="para-desc mx-auto text-muted">Extract all links found on a web page by simply providing a URL to this API. Super fast and easy to use. Give it a try </p>
