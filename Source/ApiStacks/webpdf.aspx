            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    <div class="title-heading margin-top-100">
                        <h1 class="heading mb-3">Web PDF API</h1>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12 mt-5 pt-3">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2">URL to PDF</h4>
                                <p class="text-muted">Simply provide a URL and the API will generate a PDF document for you. The returned file will be cached for continuous use</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-5 pt-3">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                ...
                                <p class="text-muted">Requested PDF will be processed by a powerful PDF rendering engine, delivering your results in seconds</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-5 pt-3">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2">Portrait or Landscape</h4>
                                <p class="text-muted">Generate your PDF in Landscape or Portrait orientation to suit your PDF needs and requirements</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-5 pt-3">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2">Custom PDF Sizing</h4>
                                <p class="text-muted">You can specify the width and height you want to capture for your PDF and Web PDF will do the rest for you</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-5 pt-3">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2">Custom Page Range</h4>
                                <p class="text-muted">Want to generate all the PDF pages, or just a few? You can easily specify how many pages you want to be rendered</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-5 pt-3">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                ...
                                <p class="text-muted">Include the background, specify the scale of the PDF, or disable 1cm margins from your generated PDF if desired</p>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                            ...
                            <div class="accordion" id="accordionExampleone">
                                <div class="card border-0 rounded mb-2">
                                    ...
                                    <div id="collapseone" class="collapse show" aria-labelledby="headingfifone" data-parent="#accordionExampleone">
                                        <div class="card-body px-2 py-4">
                                            <p class="text-muted mb-0 faq-ans">Web PDF is a service that grabs your URL and converts it into a PDF documents for use, however you see fit. That's it.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card border-0 rounded mb-2">
                                    ...
                                    <div id="collapsetwo" class="collapse" aria-labelledby="headingtwo" data-parent="#accordionExampleone">
                                        <div class="card-body px-2 py-4">
                                            <p class="text-muted mb-0 faq-ans">All you need to do is give it the URL that you want to convert into a PDF.</p>
                                            <p class="text-muted mb-0 faq-ans">The PDF is taken using a chromium browser hosted on our servers to ensure that any data is secure, optimized, and done as fast as possible.</p>
                                        </div>
                                    </div>
                                </div>
