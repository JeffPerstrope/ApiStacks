<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="languagedetect.aspx.cs" Inherits="ApiStacks.languagedetect" MasterPageFile="~/default.Master" ClientIDMode="Static" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Head" runat="server">
    <title>Language Detect | ApiStacks Restful API</title>
</asp:Content>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    <div class="title-heading margin-top-100">
                        <h1 class="heading mb-3">Language Detector API</h1>
                        ...
                        <p class="para-desc mx-auto text-muted">Feed this API a few sentences and have it determine what language it is with a confidence score. Give it a try </p>
                        ...
                        <form runat="server" id="webScnreenshotsTry">
                            ...
                            <input runat="server" id="txtAddress" type="text" class="form-control pl-5 textboxTryIt" style="display: inline-block; max-width: 500px" placeholder="Enter Text (The more words the better)" required="">
                            <button id="btnTakeScreenshot" type="submit" onclick="takeScreenshot();" class="btn btn-primary" style="display: inline-block;"><span id="spinner"></span>Detect Langugage
                            </button>
                        </form>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <h4 class="title mb-4">Send us the sentence, we'll do the rest 😎</h4>
