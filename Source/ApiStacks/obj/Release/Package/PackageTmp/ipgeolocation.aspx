<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/default.Master" CodeBehind="ipgeolocation.aspx.cs" Inherits="ApiStacks.ipgeolocation" ClientIDMode="Static" %>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    <div class="title-heading margin-top-100">
                        <h1 class="heading mb-3">IP Geolocation API</h1>
