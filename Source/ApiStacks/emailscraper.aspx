<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emailscraper.aspx.cs" Inherits="ApiStacks.emailscraper" MasterPageFile="~/default.Master" ClientIDMode="Static" %>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    <div class="title-heading margin-top-100">
                        <h1 class="heading mb-3">Email Scrapper API</h1>
                        ...
                        <form runat="server" id="webScnreenshotsTry">
                            ...
                            <button id="btnTakeScreenshot" type="submit" onclick="takeScreenshot();" class="btn btn-primary" style="display: inline-block;"><span id="spinner"></span>Scrape Emails</button>
                        </form>
                    </div>
