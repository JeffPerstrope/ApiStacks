        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    ...
                    <div class="home-dashboard" style="pointer-events: none">
                        <img runat="server" id="screenshotImage" src="images/WebScreenshots_Browser.jpeg" style="filter: drop-shadow(rgba(0, 0, 0, 0.3) 0px 16px 12px); margin-bottom: 80px; pointer-events: none" alt="" class="img-fluid">
                    </div>
                </div>
                <!--end col-->
            </div>
                                ...
                                <div class="card border-0 rounded mb-2">
                                    ...
                                    <div id="collapsetwo" class="collapse" aria-labelledby="headingtwo" data-parent="#accordionExampleone">
                                        <div class="card-body px-2 py-4">
                                            ...
                                            <p class="text-muted mb-0 faq-ans">The screenshot is taken using a chromium browser hosted on our servers to ensure that any data is secure, optimized, and done as fast as possible.</p>
                                        </div>
                                    </div>
                                </div>
